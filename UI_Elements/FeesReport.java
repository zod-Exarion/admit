...
public class FeesReport{
    ...
    public FeesReport(Student student) {
...
class MainFees extends JFrame {
    MainFees(FeesReport f){
        setTitle("Fees");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setSize(1000, 600);

        setContentPane(f.getMainPanel());

        setVisible(true);
    }
    public static void main(String[] args) {
        FeesReport f =new FeesReport(new Student("Student", new Date(2006 + (int) (8*Math.random()), Calendar.NOVEMBER, 28), "F", 70 + (int) (30*Math.random()), "a", 1L, "b", 2L, "Somewhere in this universe of aww, pain, agony and death i guess."));
        new MainFees(f);
    }
}
