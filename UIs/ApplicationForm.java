...
public class ApplicationForm {
    ...
    public void addComponentsToMainPanel() {
        ...
        NameSpace: {
            ...
            //firstNameField.setBorder(BorderFactory.createLineBorder(new Color(255,255,255)));
            ...
            DOBSpace: {
                ...
                dobLabel.setForeground(new Color(243, 96, 15));
        ...
        GenderSpace: {
            ...
            genderLabel.setForeground(new Color(243, 96, 15));
        ...
        Marks_and_Trans: {
            ...
            marksPanel.setForeground(new Color(243, 96, 15));
        ...
        MotherFatherInfo: {
            Father: {
                ...
                fatherNameLabel.setForeground(new Color(243, 96, 15));
                ...
                fatherPhoneLabel.setForeground(new Color(243, 96, 15));
            ...
            Mother: {
                ...
                motherNameLabel.setForeground(new Color(243, 96, 15));
                ...
                motherPhoneLabel.setForeground(new Color(243, 96, 15));
        ...
        Address:{
            ...
            addressPanel.setForeground(new Color(243, 96, 15));
